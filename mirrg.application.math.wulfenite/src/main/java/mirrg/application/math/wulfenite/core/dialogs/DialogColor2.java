...
public class DialogColor2 extends JDialog
{
	...
	public DialogColor2(Wulfenite game, JFrame frame)
	{
		super(frame, "色2設定");
		this.game = game;

		a = new ParameterDouble("色変化閾値", () -> game.color2_a, a -> game.color2_a = a, this::pre, this::post);
		b = new ParameterDouble("零点輝度(0~1)", () -> game.color2_b, a -> game.color2_b = a, this::pre, this::post);
		c = new ParameterDouble("閾値輝度(0~1)", () -> game.color2_c, a -> game.color2_c = a, this::pre, this::post);
